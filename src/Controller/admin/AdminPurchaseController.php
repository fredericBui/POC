...
class AdminPurchaseController extends AbstractController
{
    ...
    {
        return $this->render('admin/admin_purchase/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/admin_purchase/new.html.twig', [
            'purchase' => $purchase,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin/admin_purchase/show.html.twig', [
            'purchase' => $purchase,
        ]);
    }
    ...
    public function edit(Request $request, Purchase $purchase, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/admin_purchase/edit.html.twig', [
            'purchase' => $purchase,
            'form' => $form,
        ]);
    }
