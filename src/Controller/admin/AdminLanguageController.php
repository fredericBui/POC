...
class AdminLanguageController extends AbstractController
{
    ...
    {
        return $this->render('admin/admin_language/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/admin_language/new.html.twig', [
            'language' => $language,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin/admin_language/show.html.twig', [
            'language' => $language,
        ]);
    }
    ...
    public function edit(Request $request, Language $language, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/admin_language/edit.html.twig', [
            'language' => $language,
            'form' => $form,
        ]);
    }
